...
<div>
    ...
    <p class="autor__publication">
        Uploader:  <!-- Вивід аватара користувача -->
        <a href="<?php echo e(route('profile', $image->user->id)); ?>" style="width: 40px; height: 40px;">
            
                <img src="<?php echo e(asset('avatars/' . (file_exists(public_path('avatars/' . $image->user->avatar)) ? $image->user->avatar : 'default-avatar.png'))); ?>" 
                    alt="User Avatar" 
                    style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
            
        </a>
        <span>></span>
        <a href="<?php echo e(route('profile', $image->user->id)); ?>"><?php echo e($image->user->name); ?></a>
    </p>
...
<?php echo $__env->make('layouts/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rxniray/Проєкти/FreshNews/resources/views/image/show.blade.php ENDPATH**/ ?>